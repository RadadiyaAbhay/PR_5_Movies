...
import { addMovie } from '../../services/actions/movie.action';
      ...
      <form method='post'>
        <div className='grid grid-cols-6 gap-4'>
          ...
          <div className='col-span-3'>
            ...
            <div className='flex items-center'>
              <input type="text" className='border rounded-l-lg px-5 w-full mt-2 py-2 block' onChange={handleChange} value={arrayInput.cast} name='cast' id='cast' />
          ...
          <div className='col-start-1'>
            <button type="button" onClick={handleSubmit} className='border px-5 py-2 rounded-xl font-bold text-white bg-green-700 text-lg'>Submit</button>
          </div>
        </div>
      </form>
    </section>
